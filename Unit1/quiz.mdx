...
🎉 Congrats on finishing this quiz! If you missed some elements, take time to read again the chapter to reinforce (😏) your knowledge, but **do not worry**: during the course we'll go over these concepts again, and you'll **reinforce your theoretical knowledge with hands-on practice**!
